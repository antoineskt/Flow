  ...
  return (
    <View style={styles.corps}>
      ...
      <LinearGradient style={styles.container}  colors={['#FF3B01', '#FACA21']} >
        ...
        <Text style= {{ fontFamily: 'Roboto_900Black', fontSize: 16, color: "white", textTransform: "uppercase", textAlign: "center"}}>
        Atteinds {"\n"}
        tes {"\n"}
        objectifs 
        </Text>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("Login")} style={styles.buttondeux}>
